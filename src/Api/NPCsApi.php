...
class NPCsApi
{
     ...
     * @return \Kehet\ArtifactsMMO\Model\DataPageNPCItem
     */
    public function getAllNpcsItemsNpcsItemsGet(
        ?string $code = null,
        ?string $npc = null,
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Kehet\ArtifactsMMO\Model\DataPageNPCItem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllNpcsItemsNpcsItemsGetWithHttpInfo(
        ?string $code = null,
        ?string $npc = null,
        ?string $currency = null,
        ?int $page = 1,
     ...
     */
    public function getAllNpcsItemsNpcsItemsGetAsync(
        ?string $code = null,
        ?string $npc = null,
        ?string $currency = null,
        ?int $page = 1,
     ...
     * @return PromiseInterface
     */
    public function getAllNpcsItemsNpcsItemsGetAsyncWithHttpInfo(
        ?string $code = null,
        ?string $npc = null,
        ?string $currency = null,
        ?int $page = 1,
     ...
     */
    public function getAllNpcsItemsNpcsItemsGetRequest(
        ?string $code = null,
        ?string $npc = null,
        ?string $currency = null,
        ?int $page = 1,
     ...
     * @param  \KehetArtifactsMMOModelNPCType|null $type Type of NPCs. (optional)
     * @param  int|null $page Page number (optional, default to 1)
     * @param  int|null $size Page size (optional, default to 50)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \Kehet\ArtifactsMMO\Model\DataPageNPCSchema
     */
    public function getAllNpcsNpcsDetailsGet(
        ?string $name = null,
        ?\KehetArtifactsMMOModelNPCType $type = null,
        ?int $page = 1,
        ?int $size = 50,
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Kehet\ArtifactsMMO\Model\DataPageNPCSchema, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllNpcsNpcsDetailsGetWithHttpInfo(
        ?string $name = null,
        ?\KehetArtifactsMMOModelNPCType $type = null,
        ?int $page = 1,
        ?int $size = 50,
     ...
     * @return PromiseInterface
     */
    public function getAllNpcsNpcsDetailsGetAsync(
        ?string $name = null,
        ?\KehetArtifactsMMOModelNPCType $type = null,
        ?int $page = 1,
        ?int $size = 50,
     ...
     * @return PromiseInterface
     */
    public function getAllNpcsNpcsDetailsGetAsyncWithHttpInfo(
        ?string $name = null,
        ?\KehetArtifactsMMOModelNPCType $type = null,
        ?int $page = 1,
        ?int $size = 50,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllNpcsNpcsDetailsGetRequest(
        ?string $name = null,
        ?\KehetArtifactsMMOModelNPCType $type = null,
        ?int $page = 1,
        ?int $size = 50,
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \Kehet\ArtifactsMMO\Model\DataPageNPCItem|\Kehet\ArtifactsMMO\Model\ErrorResponseSchema
     */
    public function getNpcItemsNpcsItemsCodeGet(
        string $code,
        ?int $page = 1,
        ?int $size = 50,
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Kehet\ArtifactsMMO\Model\DataPageNPCItem|\Kehet\ArtifactsMMO\Model\ErrorResponseSchema, HTTP status code, HTTP response headers (array of strings)
     */
    public function getNpcItemsNpcsItemsCodeGetWithHttpInfo(
        string $code,
        ?int $page = 1,
        ?int $size = 50,
        string $contentType = self::contentTypes['getNpcItemsNpcsItemsCodeGet'][0]
     ...
     * @return PromiseInterface
     */
    public function getNpcItemsNpcsItemsCodeGetAsync(
        string $code,
        ?int $page = 1,
        ?int $size = 50,
        string $contentType = self::contentTypes['getNpcItemsNpcsItemsCodeGet'][0]
     ...
     * @return PromiseInterface
     */
    public function getNpcItemsNpcsItemsCodeGetAsyncWithHttpInfo(
        string $code,
        ?int $page = 1,
        ?int $size = 50,
        string $contentType = self::contentTypes['getNpcItemsNpcsItemsCodeGet'][0]
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getNpcItemsNpcsItemsCodeGetRequest(
        string $code,
        ?int $page = 1,
        ?int $size = 50,
        string $contentType = self::contentTypes['getNpcItemsNpcsItemsCodeGet'][0]
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \Kehet\ArtifactsMMO\Model\NPCResponseSchema|\Kehet\ArtifactsMMO\Model\ErrorResponseSchema
     */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Kehet\ArtifactsMMO\Model\NPCResponseSchema|\Kehet\ArtifactsMMO\Model\ErrorResponseSchema, HTTP status code, HTTP response headers (array of strings)
     */
