...
**type** | [**\Kehet\ArtifactsMMO\Model\EffectType**](EffectType.md) | Type of the effect. |
**subtype** | [**\Kehet\ArtifactsMMO\Model\EffectSubtype**](EffectSubtype.md) | Subtype of the effect. |
